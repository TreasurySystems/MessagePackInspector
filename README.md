...
It should copy all files from `/bin/Release/net48/` into fiddlers `Inspectors` folder (can usually be located at "`C:\Program Files\Fiddler\Inspectors`" or "`%LOCALAPPDATA%\Programs\Fiddler\Inspectors`").
